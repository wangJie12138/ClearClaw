...
#
# from clearclaw.core.tools.builtins import (
#     get_current_time,
#     calculator
# )
# from clearclaw.core.config import MEMORY_DIR, TASKS_FILE
#
#
...
#
#     @patch('clearclaw.core.tools.builtins.MEMORY_DIR', new_callable=lambda: tempfile.mkdtemp())
#     @patch('clearclaw.core.tools.builtins.PROFILE_PATH', new_callable=lambda: tempfile.mktemp())
#     def test_save_user_profile(self, mock_profile_path, mock_memory_dir):
#         """测试保存用户档案功能"""
#         from clearclaw.core.tools.builtins import save_user_profile
#
#         import tempfile
#         import os
#
...
#         import clearclaw.core.tools.builtins
#         clearclaw.core.tools.builtins.TASKS_FILE = self.temp_file.name
#
#     def tearDown(self):
#         # 清理临时文件
...
#         # 恢复原始路径
#         import clearclaw.core.tools.builtins
#         clearclaw.core.tools.builtins.TASKS_FILE = self.original_tasks_file
#
#     def test_schedule_task_single(self):
#         """测试单次任务调度功能"""
#         from clearclaw.core.tools.builtins import schedule_task, list_scheduled_tasks
#
...
#         """测试调度任务 - 无效时间格式"""
#         from clearclaw.core.tools.builtins import schedule_task
#
...
#         """测试列出空任务列表"""
#         from clearclaw.core.tools.builtins import list_scheduled_tasks
#
#         # 确保文件为空
...
#         """测试获取系统模型信息功能"""
#         from clearclaw.core.tools.builtins import get_system_model_info
#
#         # 保存原有环境变量
...
#         self.original_tasks_file = TASKS_FILE
#         import clearclaw.core.tools.builtins
#         clearclaw.core.tools.builtins.TASKS_FILE = self.temp_tasks_file.name
#
#         # 添加一些测试任务
#         future_time = (datetime.now().replace(hour=9, minute=0, second=0)
#                       if datetime.now().hour >= 9 else
...
#         """测试删除计划任务"""
#         from clearclaw.core.tools.builtins import delete_scheduled_task, list_scheduled_tasks
#
...
#         """测试删除不存在的任务"""
#         from clearclaw.core.tools.builtins import delete_scheduled_task
#
...
#         """测试修改计划任务"""
#         from clearclaw.core.tools.builtins import modify_scheduled_task, list_scheduled_tasks
#
...
#         """测试修改计划任务 - 无效时间格式"""
#         from clearclaw.core.tools.builtins import modify_scheduled_task
#
