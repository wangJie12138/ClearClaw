...
from clearclaw.core.context import AgentState
...
class TestAgent(unittest.TestCase):
    ...
    @patch('clearclaw.core.provider.get_provider')
    @patch('clearclaw.core.skill_loader.load_dynamic_skills')
    @patch('clearclaw.core.tools.builtins.BUILTIN_TOOLS', [])
